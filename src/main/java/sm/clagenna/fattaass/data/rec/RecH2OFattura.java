...
@Data
public class RecH2OFattura implements IRecFattura {
  ...
  private LocalDateTime periodStimDtIniz;
  private LocalDateTime periodStimDtFine;
  private double        assicurazione;
  private double        impostaQuiet;
  private double        restituzAccPrec;
  private double        totPagare;
  private String        nomeFile;

  public RecH2OFattura() {
  }
  ...
  public String toString() {
    ...
    sb.append(String.format("\t%-16s %s\n", "periodStimDtIniz", ParseData.formatDate(periodStimDtIniz)));
    sb.append(String.format("\t%-16s %s\n", "periodStimDtFine", ParseData.formatDate(periodStimDtFine)));
    sb.append(String.format("\t%-16s %s\n", "assicurazione", Utils.formatDouble(assicurazione)));
    sb.append(String.format("\t%-16s %s\n", "impostaQuiet", Utils.formatDouble(impostaQuiet)));
    sb.append(String.format("\t%-16s %s\n", "RestituzAccPrec", Utils.formatDouble(restituzAccPrec)));
