...
public abstract class BaseSQLite implements ISql {
  ...
  public BaseSQLite(IParserFatture p_fact, FattAassModel p_mod) {
    init(p_fact, p_mod);
  }
  ...
  public void init(IParserFatture p_fact, FattAassModel p_mod) {
    ...
    try {
      ...
      getLog().error("Error prep stmt: %s", szQry, e);
    }
  }
  ...
  public boolean fatturaExist() throws SQLException {
    ...
    try {
      ...
      getLog().error("Su fattura Exist Non trovo {}", Consts.TGV_DataEmiss);
