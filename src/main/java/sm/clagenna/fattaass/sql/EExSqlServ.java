...
public class EExSqlServ extends BaseSqlServ implements ISql {
  private static final Logger s_log = LogManager.getLogger(EExSqlServ.class);
  ...
  public EExSqlServ(IParserFatture p_fact, FattAassModel p_mod) {
    init(p_fact, p_mod);
  }
